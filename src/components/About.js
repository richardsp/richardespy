...
const About = () => {
  return (
    <div className="bio">
      ...
      <p>
        This site is where I share my professional achievements, culinary adventures, and personal musings. Here, you&apos;ll find my resume, recipes, and travel experiences. It&apos;s a reflection of who I am – a tech enthusiast, a creative cook, and a perpetual optimist... and my personal self-teaching space.
      </p>
      <p>
