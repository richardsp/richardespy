...
export const recipeMetadata = {
  ...
  made: true,
  keeper: true,
  description: "This is my own recipe for Chicken Rice, a favorite dish in my household. One of the best things about it is that it only uses 3 dishes to cook it!",
  prepTime: '15 minutes',
...
const ChickenRice = () => {
  return <RecipeTemplate metadata={recipeMetadata} />;
};
